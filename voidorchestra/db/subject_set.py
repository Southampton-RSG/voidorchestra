...
class SubjectSet(Base):
    ...
    lightcurve_collection_id: Mapped[int] = mapped_column(ForeignKey("lightcurve_collection.id"))
    sonification_profile_id: Mapped[int] = mapped_column(ForeignKey("sonification_profile.id"))
